...
def build_system_prompt(settings: dict, feedback_history: list) -> str:
    ...
    tone_map = {
        ...
        "friendly": "тёплый и дружелюбный, на «ты» или «вы», эмодзи уместны (2-3 шт.) — живо и с душой",
        "creative": "оригинальный и остроумный, лёгкая ирония допустима, но строго в рамках вежливости — никаких оскорблений; для сложных и придирчивых покупателей",
    }
    len_map = {
