...
app.add_middleware(
    ...
    allow_origins=[
        "http://127.0.0.1:8000",
        "http://localhost:8000",
        "null",  # file:// протокол: ReviewBot.bat открывает HTML напрямую из файловой системы
    ],
...
def build_system_prompt(settings: dict, feedback_history: list) -> str:
    ...
    tone_map = {
        "neutral":  "нейтральный деловой, на «вы», без эмодзи — чётко и по делу",
        "friendly": "тёплый и дружелюбный, на «вы», эмодзи уместны (2-3 шт.) — живо и с душой",
        "creative": "оригинальный и индивидуальный стиль, тонкий юмор и лёгкая ирония — без фамильярности, панибратства, жаргона, дворовой и подростковой речи; строго вежливо, на «вы», без хамства",
    }
    len_map = {
