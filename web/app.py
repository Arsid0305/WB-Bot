...
def build_system_prompt(settings: dict, feedback_history: list) -> str:
    ...
    tone_map = {
        ...
        "creative": "креативный и нестандартный: неожиданные метафоры, живые образы, лёгкий ненавязчивый юмор где уместно — но строго без обещаний скидок/подарков, без сравнения с конкурентами, без медицинских заявлений; всё в рамках оферты WB/Ozon",
    }
    len_map = {
